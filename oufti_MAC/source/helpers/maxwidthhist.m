function varargout = maxwidthhist(varargin)
% maxwidthhist(cellList)
% maxwidthhist(cellList1,cellList2,...)
% maxwidthhist(cellList,xarray)
% maxwidthhist(cellList1,cellList2,xarray)
% maxwidthhist(cellList1,pix2mu)
% maxwidthhist(cellList1,pix2mu1,cellList2,pix2mu2)
% maxwidthhist(cellList1,cellList2,'overlap') 
% maxwidthhist(...'nooutput') 
% maxwidthhist(...'nodisp') 
% maxwidthhlist = maxwidthhist(cellList)
% [maxwidthhlist1,maxwidthhlist2] = maxwidthhist(cellList1,cellList2)
% 
% This function plots a histogram of the maximum width of every cell in a
% population
% 
...
% <maxnwidthhlist>, <maxwidthhlist1>, <maxwidthhlist2> - arrays containing
%     the width of every cell to save and plot separately.
...
if ~isfield(varargin{1},'meshData')
    ...
    expr = 'mesh=cellStructure.mesh; w=sqrt((mesh(:,4)-mesh(:,2)).^2+(mesh(:,3)-mesh(:,1)).^2); value=max(w);';
end
